Gem::Specification.new do |s|
  s.name = %q{rails3-restful-authentication}
  s.version = "3.0.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Vishnu Atrai"]
  s.date = %q{2012-07-04}
  s.description = %q{This gem provides rails 3 support for original restfull authontication( https://github.com/technoweenie/restful-authentication ).}
  s.email = %q{vishnu.atrai@gmail.com}
  ...
  s.has_rdoc = true
  s.homepage = %q{ https://github.com/vatrai/rails3-restful-authentication }
